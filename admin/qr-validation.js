// ==============================================
// QR-VALIDATION.JS - QR Code Validation Module
// ==============================================
// This file handles all QR code validation functionality
// Compatible with Student Council Payment Settings Modal

console.log('🔧 QR Validation Module Loading...');
...
function loadJsQRLibrary() {
    return new Promise((resolve, reject) => {
        ...
        console.log('📦 Loading jsQR library from CDN...');
...
function validateQRCode(file) {
    return new Promise(async (resolve, reject) => {
        console.log('🔍 Starting QR validation for file:', file?.name);
        ...
        reader.onload = function(e) {
            ...
            img.onload = function() {
                ...
                console.log('✅ QR Code detected! Data:', qrCode.data);
...
function setupPaymentQRValidation() {
    console.log('🎯 Setting up Payment QR validation...');
    
    const qrInput = document.getElementById('paymentQR');
    if (!qrInput) {
        console.warn('⚠️ Payment QR input not found (id="paymentQR")');
        return;
    }

    console.log('✅ Found payment QR input');
    ...
    if (!validationContainer) {
        ...
        console.log('✅ Created validation container');
    }
    ...
    console.log('✅ QR validation setup complete');
}
...
function openUploadQRModal() {
    console.log('📤 Opening Upload QR Modal...');
    ...
    qrInput.addEventListener('change', async function(e) {
        ...
        console.log('📁 File selected in upload modal:', file?.name);
        ...
        try {
            ...
            console.log('✅ Upload modal QR validation successful');

        } catch (error) {
            console.error('❌ Upload modal QR validation failed:', error);
    ...
    console.log('✅ Upload QR Modal opened');
}

function closeUploadQRModal() {
    console.log('❌ Closing Upload QR Modal...');
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Initializing QR Validation Module...');
    ...
    if (openPaymentSettingsBtn) {
        console.log('✅ Found "Payment Settings" button');
        
        // Wrap the original click handler
        const originalOnClick = openPaymentSettingsBtn.onclick;
        ...
        openPaymentSettingsBtn.addEventListener('click', function(e) {
            ...
            setTimeout(() => {
                console.log('⏰ Setting up QR validation after modal render...');
                setupPaymentQRValidation();
            }, 200);
        });
        
        console.log('✅ Payment settings button listener added');
    } else {
        console.warn('⚠️ Payment Settings button not found (id="openPaymentSettings")');
    }

    console.log('✅ QR Validation Module initialized');
});
...
window.setupPaymentQRValidation = setupPaymentQRValidation;
window.openUploadQRModal = openUploadQRModal;
window.closeUploadQRModal = closeUploadQRModal;

console.log('✅ QR Validation Module loaded successfully');