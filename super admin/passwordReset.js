...
const sampleAdminsPasswordReset = [
    { id: 1, name: 'Accounting', department: 'Accounting', role: 'Admin', status: 'Active', email: 'accounting.pupsmb@gmail.com' },
    { id: 2, name: 'Director', department: 'Administration', role: 'Admin', status: 'Active', email: 'director.pupsmb@gmail.com' },
    { id: 3, name: 'Gymnasium', department: 'Sports', role: 'Admin', status: 'Active', email: 'gymnasium.pupsmb@gmail.com' },
    { id: 4, name: 'Laboratory', department: 'Laboratory', role: 'Admin', status: 'Active', email: 'laboratory.pupsmb@gmail.com' },
    { id: 5, name: 'Library', department: 'Library', role: 'Admin', status: 'Active', email: 'library.pupsmb@gmail.com' },
    { id: 6, name: 'Nurse', department: 'Medical', role: 'Admin', status: 'Active', email: 'nurse.pupsmb@gmail.com' },
    { id: 7, name: 'Student Organization', department: 'Student Affairs', role: 'Admin', status: 'Active', email: 'organization.pupsmb@gmail.com' },
    { id: 8, name: 'Student Publication', department: 'Media', role: 'Admin', status: 'Active', email: 'publication.pupsmb@gmail.com' },
    { id: 9, name: 'Student Service Office (SSO)', department: 'Student Services', role: 'Admin', status: 'Active', email: 'sso.pupsmb@gmail.com' },
    { id: 10, name: 'Student Council', department: 'Student Government', role: 'Admin', status: 'Active', email: 'studentcouncil.pupsmb@gmail.com' }
];
    ...
    form.addEventListener('submit', async function (e) {
        ...
        showConfirm(
            ...
            async function () {
                ...
                const success = await updateAdminPassword(adminId, newPassword, adminName, adminEmail);
    ...
    try {
        ...
        const response = await fetch(`${apiUrl}/admin/reset-password`, {
            ...
            body: JSON.stringify({
                ...
                super_admin_email: JSON.parse(localStorage.getItem('currentUser') || '{}').email || ''
            })
        });
